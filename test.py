...
response_put = requests.put(f"{BASE}/workouts/{id1}", json={"date": "11/26/2024", "distance": "1mile", "time": "5min"})
print(response_put.status_code)
print(json.dumps(response_put.json(), indent=2))
print("-" * 50)

response_put = requests.put(f"{BASE}/workouts/{id1}", json={"date": "11/27/2024", "distance": "11mile", "time": "15min"})
print(response_put.status_code)
print(json.dumps(response_put.json(), indent=2))
print("-" * 50)

response_put = requests.put(f"{BASE}/workouts/{id2}", json={"date": "11/28/2024", "distance": "21mile", "time": "25min"})
print(response_put.status_code)
print(json.dumps(response_put.json(), indent=2))
print("-" * 50)

response_put = requests.put(f"{BASE}/workouts/{id2}", json={"date": "11/29/2024", "distance": "31mile", "time": "35min"})
print(response_put.status_code)
print(json.dumps(response_put.json(), indent=2))
print("-" * 50)
